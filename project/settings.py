...
SECRET_KEY = 'django-insecure-s-!ie1ms5b0v(s(5nvf1g!lo%njmah)!t5w052n-7hegd-0u)d'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "irajnepali8@gmail.com"
EMAIL_HOST_PASSWORD = "lftr xoxz mggc jvpx"  # Use app password if 2FA enabled
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "SkillPathsala",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "SkillPathsala",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "SkillPathsala",
